...
// Generate a unique reason for this test
$reason = "Testing manual token addition with reason - " . date('Y-m-d H:i:s');
...
// Now query the database directly to see the stored manual token addition
echo "Checking the database for the stored reason...\n";
...
$stmt = $db_connection->prepare("
    SELECT * FROM manual_token_additions 
    WHERE reason = ? 
...
echo "Manual token addition record from database:\n";
print_r($record);
